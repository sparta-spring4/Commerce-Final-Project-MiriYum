...
import { clearPlatformOperatorProtectedQueries } from './querySession'
...
} from '../../../domains/account/platform-operator/auth/api/platformOperatorAuthApi'
import {
  fetchPlatformOperatorCapabilities,
  platformOperatorCapabilitiesQueryKey,
  type PlatformOperatorCapabilitiesData,
} from '../../../domains/account/platform-operator/auth/api/platformOperatorCapabilitiesApi'
import { PLATFORM_OPERATOR_CSRF_COOKIE } from '../../../domains/account/platform-operator/auth/model/csrfCookie'
import {
  isRefreshablePlatformOperatorAuthError,
  isInitialPasswordChangeRequired,
} from '../../../domains/account/platform-operator/auth/model/platformOperatorErrors'
import {
  resolveCapabilities,
  type CapabilityState,
} from '../../../domains/account/platform-operator/auth/model/capabilities'
