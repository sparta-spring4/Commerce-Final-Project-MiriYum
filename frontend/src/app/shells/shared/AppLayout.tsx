...
const TAB_ICON: Record<string, IconName> = {
  [PUBLIC_PATHS.home]: 'store',
  [PUBLIC_PATHS.stores]: 'search',
 ...
 */
export function AppLayout({ isConsumer, navigation: items, accountSlot }: Props) {
  return (
    <>
      ...
      <header className="app-header">
        <div className="mi-container app-header__inner">
          <Link className="app-header__brand" to={PUBLIC_PATHS.home}>
            MiriYum
          </Link>
          {/*
          ...
          <div className="app-footer__columns">
            ...
            */}
            <nav aria-label="서비스 메뉴">
              ...
              <div className="app-footer__links">
                <Link to={PUBLIC_PATHS.stores}>매장 찾기</Link>
                {isConsumer && (
                  <Link to={CONSUMER_PATHS.myReservations}>내 예약</Link>
                )}
              </div>
            </nav>
            ...
            */}
            <nav aria-label="계정 메뉴">
              ...
              <div className="app-footer__links">
                {isConsumer ? (
                  <Link to={CONSUMER_PATHS.myPage}>마이페이지</Link>
                ) : (
                  <>
                    <Link to={CONSUMER_PATHS.signIn}>로그인</Link>
                    <Link to={CONSUMER_PATHS.signUp}>회원가입</Link>
                  </>
                )}
              </div>
            </nav>
