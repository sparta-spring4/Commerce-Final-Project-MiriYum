...
function renderCreatePage() {
  return renderOperator(<MenuEditorPage />, {
    route: fillPath(STORE_OPERATOR_PATHS.menuCreate, { storeId: STORE_ID }),
    path: STORE_OPERATOR_PATHS.menuCreate,
    probePaths: [STORE_OPERATOR_PATHS.menu],
  })
}

function renderEditPage() {
  return renderOperator(<MenuEditorPage />, {
    route: fillPath(STORE_OPERATOR_PATHS.menu, {
      storeId: STORE_ID,
      menuId: MENU_ID,
    }),
    path: STORE_OPERATOR_PATHS.menu,
  })
}
