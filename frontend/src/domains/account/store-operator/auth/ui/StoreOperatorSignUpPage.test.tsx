...
import { OPERATOR_ACCOUNTS_PATH } from '../../../../store/store-operator/test/handlers'
...
function renderSignUp() {
  return render(
    <MemoryRouter initialEntries={[STORE_OPERATOR_PATHS.signUp]}>
      <Routes>
        <Route
          path={STORE_OPERATOR_PATHS.signUp}
