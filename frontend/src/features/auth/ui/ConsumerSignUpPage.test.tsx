...
function renderSignUp() {
  return render(
    <MemoryRouter initialEntries={[ROUTES.consumerSignUp]}>
      <Routes>
        <Route path={ROUTES.consumerSignUp} element={<ConsumerSignUpPage />} />
        <Route path={ROUTES.consumerSignIn} element={<p>로그인 화면</p>} />
      </Routes>
    </MemoryRouter>,
  )
}
