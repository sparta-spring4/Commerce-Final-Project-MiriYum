...
| `frontend.dev` | `NOT RUN` | Development server | `pnpm run dev` | Installed dependencies and an available local port | Vite development server starts | Observed startup output and explicit shutdown | `FAIL`; not run is `NOT RUN` |
