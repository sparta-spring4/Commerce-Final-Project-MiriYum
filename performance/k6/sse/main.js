...
const unexpectedCodeCommon010 = new Counter('sse_unexpected_code_common_010')
const unexpectedCodeAuth006 = new Counter('sse_unexpected_code_auth_006')
const unexpectedCodeAuth009 = new Counter('sse_unexpected_code_auth_009')
const unexpectedCodeAuth010 = new Counter('sse_unexpected_code_auth_010')
const unexpectedCodeAuth011 = new Counter('sse_unexpected_code_auth_011')
const unexpectedCodeAuth012 = new Counter('sse_unexpected_code_auth_012')
const unexpectedCodeOtherOrMissing = new Counter('sse_unexpected_code_other_or_missing')
...
function recordUnexpected4xx(diagnostic, tags) {
  ...
  if (diagnostic?.errorCodeBucket === 'COMMON_010') unexpectedCodeCommon010.add(1, tags)
  else if (diagnostic?.errorCodeBucket === 'AUTH_006') unexpectedCodeAuth006.add(1, tags)
  else if (diagnostic?.errorCodeBucket === 'AUTH_009') unexpectedCodeAuth009.add(1, tags)
  else if (diagnostic?.errorCodeBucket === 'AUTH_010') unexpectedCodeAuth010.add(1, tags)
  else if (diagnostic?.errorCodeBucket === 'AUTH_011') unexpectedCodeAuth011.add(1, tags)
  else if (diagnostic?.errorCodeBucket === 'AUTH_012') unexpectedCodeAuth012.add(1, tags)
  else unexpectedCodeOtherOrMissing.add(1, tags)
