...
| 플랫폼 운영자·분쟁·수동 복구 | ADMIN-001, ADMIN-002, ADMIN-003, ADMIN-004, ADMIN-005, ADMIN-006, ADMIN-007, ADMIN-008, ADMIN-009, ADMIN-010, ADMIN-011, ADMIN-012 | 확정·TODO 혼재 | `고도화` | 모든 고도화 도메인 | [정책 원본](service-policies/15-admin-operation.md) · [인증·세션 기능 명세](specs/platform-operator-auth/spec.md) · [권한·재인증 기능 명세](specs/platform-operator-authorization/spec.md) · [회원지원 기능 명세](specs/member-support/spec.md) | 별도 플랫폼 운영자 인증·권한 기반 위에 최소 회원 조회, mock 확인 기반 수동 복구, 단계형 제재와 이의 사건 관리를 활성화한다. |
