...
| 플랫폼 운영자·분쟁·수동 복구 | ADMIN-001, ADMIN-002, ADMIN-003, ADMIN-004, ADMIN-005, ADMIN-006, ADMIN-007, ADMIN-008, ADMIN-009, ADMIN-010, ADMIN-011, ADMIN-012 | 확정·TODO 혼재 | `고도화` | 모든 고도화 도메인 | [정책 원본](service-policies/15-admin-operation.md) · [인증·세션 기능 명세](specs/platform-operator-auth/spec.md) · [권한·재인증 기능 명세](specs/platform-operator-authorization/spec.md) | 별도 플랫폼 운영자 계정의 심사·분쟁·복구·장애 기능은 고도화에서만 진입한다. 인증·세션·최초 비밀번호 변경을 먼저 활성화하고 역할·세부 권한·사건 배정·일회 승인 공통 기반을 거친 뒤 실제 업무 명령을 연결한다. |
