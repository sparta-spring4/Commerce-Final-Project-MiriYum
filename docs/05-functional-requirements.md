...
| 광고·추천 | ADS-001, ADS-002, ADS-003, ADS-004, ADS-005, ADS-006, ADS-007, ADS-008 | 부분 초기 | store | [정책 원본](service-policies/13-ad-recommendation.md) | 하나의 검색창에서 검색어와 구조화 조건을 함께 추출하는 통합 검색, 규칙 우선·선택적 외부 AI 보조·MySQL 직접 조회와 취향·품절 대체 추천은 초기 무료 기능이다. OpenSearch와 Meilisearch는 도입 여부가 확정된 MVP 제외 기술이며 광고 상품·과금·광고 제거도 제외한다. |
