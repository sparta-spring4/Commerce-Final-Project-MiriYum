...
| 체크인·노쇼 | CHECK-001, CHECK-002, CHECK-003, CHECK-004, CHECK-005, CHECK-006, CHECK-007, CHECK-008, CHECK-009, CHECK-010 | 확정 | `고도화` | reservation | [정책 원본](service-policies/09-checkin-noshow.md) | 고도화는 회전형 QR과 노쇼 절차를 제공하며, 1차 MVP 운영자 직접 방문 완료 결과를 보조 방문 증거로 소비한다. QR은 #52의 선행 조건이나 대체 endpoint가 아니다. |
