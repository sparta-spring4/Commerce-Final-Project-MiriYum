...
```text
sourceEventId + recipientAccountId + purpose + resourceType + resourceId + resourceVersion
```
...
- `actionType`, `actionResourceType`, nullable `actionResourceId`, `actionAvailability`
