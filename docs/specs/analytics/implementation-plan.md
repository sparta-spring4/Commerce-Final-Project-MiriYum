...
- V49 and V50 are on `dev`. V51 is reserved for #270 by explicit user direction; verify it remains latest `dev` max + 1 before the final merge and verify the complete clean and upgrade paths.
...
```java
@Test
void v51CreatesAuthorityVersionAndAtomicMetricKeys() {
