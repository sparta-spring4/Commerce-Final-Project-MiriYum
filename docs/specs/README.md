...
- [입점 신청 사업자등록증 비공개 증빙](store-onboarding/spec.md) · [ERD](store-onboarding/erd.md): #344가 소유하는 불투명 증빙 식별자, 교체 이력과 Store 공개 Service/DTO 경계
...
- [예약·웨이팅 통합 모니터링](admin-monitoring/spec.md): #280이 소유하는 사건 중심 원장 조합·부분 실패·최소 마스킹 조회 계약
