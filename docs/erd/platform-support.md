...
erDiagram
    ...
    PLATFORM_OPERATOR_ROLE_GRANTS ||--o{ PLATFORM_OPERATOR_PERMISSION_GRANTS : expands
    ...
    MEMBER_SUPPORT_CASES ||--o{ MEMBER_SUPPORT_AUDITS : audits
    ...
    PAYMENT_RECOVERY_CASES ||--o{ PAYMENT_RECOVERY_APPROVALS : approves
