...
- [ ] **1단계: AUTH-007 현재 정책을 JWT·Valkey 구조로 교체**
...
- [ ] **2단계: OpenSearch·Meilisearch 경계 수정**
...
- [ ] **3단계: 사용자 흐름·기능 요구사항·API 소유 경계 정렬**
...
- [ ] **4단계: 아키텍처·신뢰성 문서에서 검색 인덱스 의존 제거**
