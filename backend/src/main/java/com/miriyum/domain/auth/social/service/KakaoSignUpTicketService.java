...
public class KakaoSignUpTicketService {
    ...
    public String create(TokenNamespace namespace, String providerSubjectFingerprint) {
        if (providerSubjectFingerprint == null || providerSubjectFingerprint.isBlank()) {
            throw new IllegalArgumentException("providerSubjectFingerprint must not be blank");
        }
    ...
    public KakaoSignUpTicket parse(String ticket) {
        try {
            ...
            return new KakaoSignUpTicket(namespace, fingerprint);
