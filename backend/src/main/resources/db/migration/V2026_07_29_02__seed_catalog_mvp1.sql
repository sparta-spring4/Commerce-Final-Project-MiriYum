...
INSERT INTO store_category (code, display_name, active, sort_order) VALUES
    ...
    ('WESTERN',     '양식',          TRUE, 4),
    ('ASIAN',       '아시아 음식',   TRUE, 5),
    ('CAFE_BAKERY', '카페·베이커리', TRUE, 6),
    ('BAR',         '주점',          TRUE, 7),
    ('ETC',         '기타',          TRUE, 8);

-- 메뉴 카테고리 (10)
INSERT INTO menu_category (code, display_name, active, sort_order) VALUES
    ('RICE',                  '밥요리',             TRUE, 1),
    ('NOODLE',                '면요리',             TRUE, 2),
    ('SOUP_STEW',             '국·탕·찌개',         TRUE, 3),
    ('MEAT',                  '고기요리',           TRUE, 4),
    ('SEAFOOD',               '해산물요리',         TRUE, 5),
    ('PIZZA_BURGER_SANDWICH', '피자·버거·샌드위치', TRUE, 6),
    ('BAKERY',                '베이커리',           TRUE, 7),
    ('DESSERT',               '디저트',             TRUE, 8),
    ('BEVERAGE',              '음료',               TRUE, 9),
    ('ETC',                   '기타',               TRUE, 10);
...
-- 매장 태그 (8)
INSERT INTO store_tag (code, display_name, active, sort_order) VALUES
    ('DATE',         '데이트',            TRUE, 1),
    ('QUIET',        '조용한',            TRUE, 2),
    ('GROUP',        '모임',              TRUE, 3),
    ('SOLO',         '혼밥',              TRUE, 4),
    ('FAMILY',       '가족식사',          TRUE, 5),
    ('VEGAN_OPTION', '비건 옵션',         TRUE, 6),
