...
ALTER TABLE platform_operator_audit_events
    ADD CONSTRAINT ck_platform_operator_audit_events_action CHECK (action IN (
        ...
        'ONBOARDING_CASE_READ', 'ONBOARDING_CASE_ASSIGNED', 'ONBOARDING_CASE_REASSIGNED',
        'ONBOARDING_DECIDED', 'ONBOARDING_EVIDENCE_READ',
    ...
    ADD CONSTRAINT ck_platform_operator_audit_events_reason CHECK (reason IN (
        ...
        'STORE_ENFORCEMENT', 'PAYMENT_RECOVERY', 'ONBOARDING_REVIEW'
    ));
...
CREATE TABLE store_onboarding_applications (
    ...
    current_request_idempotency_key  VARCHAR(100) COLLATE utf8mb4_0900_as_cs NOT NULL,
    current_request_fingerprint      CHAR(64)     COLLATE utf8mb4_0900_as_cs NOT NULL,
...
CREATE TABLE store_onboarding_application_versions (
    ...
    verified_address                        VARCHAR(300) NOT NULL,
    geocoding_verified_at                   DATETIME(6) NOT NULL,
    ...
    primary_business_category               VARCHAR(100) NOT NULL,
    primary_business_item                   VARCHAR(100) NOT NULL,
