...
결제·환불과 결제 제공자·Webhook 동기화, 알림, 웨이팅과 실시간 전달, 취소 자리 자동 승계·빈자리 알림, 웨이팅 기반 지도 추천, 체크인·노쇼, 카카오 소셜 로그인·세션, 관련 이력 모듈도 고도화라는 이름이 아니라 같은 활성화 공식으로 판단한다. 각 기능은 서로 독립된 계약, Controller·Service 실제 구현, 호출 가능 증거, 현재 배포 승인을 확인한다.
